# SmartCrops Platform — Solution Architecture Document (SAD)
...
- Google Cloud VCN (10.20.0.0/16)
- Subnets: Web (10.20.10.0/24) / Core (10.20.20.0/24) / DB (10.20.30.0/24) / Monitoring (10.20.40.0/24)
...
This **SAD v1.0** is a full, enterprise-grade architectural specification aligned with TOGAF, C4, IEEE 42010, and the SmartCrops FSR.
